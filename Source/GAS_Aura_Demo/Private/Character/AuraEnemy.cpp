...
void AAuraEnemy::PossessedBy(AController* NewController)
{
	...
	AuraAIController->GetBlackboardComponent()->SetValueAsBool(FName("RangedEnemy"), CharacterClass != ECharacterClass::Warrior);
}

void AAuraEnemy::Highlight_Implementation()
{
	GetMesh()->SetRenderCustomDepth(true);
	Weapon->SetRenderCustomDepth(true);
}

void AAuraEnemy::UnHighlight_Implementation()
{
...
int32 AAuraEnemy::GetCombatCharacterLevel_Implementation()
{
	return Level;
}
