...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Attributes_Primary_Resilence=UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Attributes.Primary.Resilence"),FString(TEXT("增加护甲与护甲穿透")));
	GameplayTags.Attributes_Primary_Vigor=UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Attributes.Primary.Vigor"),FString(TEXT("增加最大生命值")));

	//~ 次要属性
	GameplayTags.Attributes_Secondary_Amor=UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Attributes.Secondary.Amor"),FString(TEXT("减少受到的伤害，增加格挡概率")));
	GameplayTags.Attributes_Secondary_AmorPenetration=UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Attributes.Secondary.AmorPenetration"),FString(TEXT("忽视敌人护甲，增加暴击概率")));
